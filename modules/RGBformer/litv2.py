...
class LITv2(nn.Module):
    def __init__(self, img_size=224, patch_size=4, in_chans=3,
                 ...
                 use_checkpoint=False, has_msa=[0, 0, 1, 1], alpha=0.5, local_ws=None,  **kwargs):
        super().__init__()
        ...
        for i_layer in range(self.num_layers):
            layer = LITLayer(dim=int(embed_dim * 2 ** i_layer),
                               ...
                               use_checkpoint=use_checkpoint, has_msa=self.has_msa[i_layer]==1, local_ws=self.local_ws[i_layer], alpha=alpha)
